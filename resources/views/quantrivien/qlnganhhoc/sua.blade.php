...
@section('main')
    <form action="{{ route('nganh-hoc.update', ['id' => $nganhhoc->id]) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ma_nganh" name="ma_nganh" value="{{ $nganhhoc->ma_nganh }}" placeholder="Nhập mã ngành" autocomplete="off"
                required>
            @error('ma_nganh')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ten_nganh" name="ten_nganh" value="{{ $nganhhoc->ten_nganh }}" placeholder="Nhập tên ngành" autocomplete="off" required>
            @error('ten_nganh')
                <small class="help-block">{{ $message }}</small>
            @enderror
        </div>
