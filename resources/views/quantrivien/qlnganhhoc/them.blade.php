...
@section('main')
    <form action="{{ route('nganh-hoc.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input id="ma_nganh" type="text" class="form-control form-control-sm" name="ma_nganh" placeholder="Nhập mã ngành" autocomplete="off"
                required autofocus>
            @error('ma_nganh')
        ...
        <div class="form-group">
            ...
            <input id="ten_nganh" type="text" class="form-control form-control-sm" name="ten_nganh" placeholder="Nhập tên ngành" autocomplete="off" required>
            @error('ten_nganh')
                <small class="help-block">{{ $message }}</small>
            @enderror
        </div>
