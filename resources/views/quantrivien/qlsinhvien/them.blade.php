...
@section('main')
    <form action="{{ route('sinh-vien.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input id="ma_sinh_vien" type="text" class="form-control form-control-sm" name="ma_sinh_vien" placeholder="Nhập mã sinh viên"
        ...
        <div class="form-group">
            ...
            <input id="email" type="email" class="form-control form-control-sm" name="email" placeholder="Nhập tên khoa" autocomplete="off"
                required>
            @error('email')
                <small class="help-block">{{ $message }}</small>
            @enderror
