...
@section('main')
    <form action="{{ route('sinh-vien.update', ['id' => $sinhvien->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input id="ma_sinh_vien" type="text" class="form-control" name="ma_sinh_vien" value="{{ $sinhvien->ma_sinh_vien }}" placeholder="Nhập mã sinh viên"
        ...
        <div class="form-group">
            ...
            <input id="ho_ten" type="text" class="form-control" name="ho_ten" value="{{ $sinhvien->ho_ten }}" placeholder="Nhập họ tên" autocomplete="off"
                required>
            @error('ho_ten')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="email" type="email" class="form-control" name="email" value="{{ $sinhvien->email }}" placeholder="Nhập tên khoa" autocomplete="off"
                required>
            @error('email')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="ngay_sinh" type="date" class="form-control" name="ngay_sinh" value="{{ $sinhvien->ngay_sinh }}" placeholder="Nhập ngày sinh" autocomplete="off"
                required>
            @error('ngay_sinh')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="que_quan" type="text" class="form-control" name="que_quan" value="{{ $sinhvien->que_quan }}" placeholder="Nhập quê quán" autocomplete="off"
                required>
            @error('que_quan')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="so_dien_thoai" type="text" class="form-control" name="so_dien_thoai" value="{{ $sinhvien->so_dien_thoai }}" placeholder="Nhập số điện thoại" autocomplete="off"
                required>
            @error('so_dien_thoai')
                <small class="help-block">{{ $message }}</small>
            @enderror
