...
@section('main')
    <form action="{{ route('giang-vien.update', ['id' => $giangvien->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input id="ma_giang_vien" type="text" class="form-control form-control-sm" name="ma_giang_vien" value="{{ $giangvien->ma_giang_vien }}" placeholder="Nhập mã sinh viên"
        ...
        <div class="form-group">
            ...
            <input id="ho_ten" type="text" class="form-control form-control-sm" name="ho_ten" value="{{ $giangvien->ho_ten }}" placeholder="Nhập họ tên" autocomplete="off"
                required>
            @error('ho_ten')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="ngay_sinh" type="date" class="form-control form-control-sm" name="ngay_sinh" value="{{ $giangvien->ngay_sinh }}" placeholder="Nhập ngày sinh" autocomplete="off"
                required>
            @error('ngay_sinh')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="que_quan" type="text" class="form-control form-control-sm" name="que_quan" value="{{ $giangvien->que_quan }}" placeholder="Nhập quê quán" autocomplete="off"
                required>
            @error('que_quan')
                <small class="help-block">{{ $message }}</small>
            @enderror
        ...
        <div class="form-group">
            ...
            <input id="so_dien_thoai" type="text" class="form-control form-control-sm" name="so_dien_thoai" value="{{ $giangvien->so_dien_thoai }}" placeholder="Nhập số điện thoại" autocomplete="off"
                required>
            @error('so_dien_thoai')
                <small class="help-block">{{ $message }}</small>
            @enderror
